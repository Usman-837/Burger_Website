        ...
        <>
            <section id="category">
                <div className="container flex flex-col gap-5 md:flex-row"> 
                    {/* card 1 */}
                    <div data-aos="fade-down-right" className="bg-secondaryColor flex py-3 rounded-lg overflow-hidden md:flex-1">
                     ...
                     {/* card 2 */}
                     <div data-aos="fade-up" className="bg-redColor flex py-3 rounded-lg overflow-hidden md:flex-1">
                        <div className="basis-1/3 relative">
                            <img src={burger1} alt="category image" className="absolute w-28 -button-4 left-4"/>
                        </div>
                        <div className="mb-2">
                    ...
                    {/* card 3 */}
                    <div data-aos="fade-down-left" className="bg-greenColor flex py-3 rounded-lg overflow-hidden md:flex-1">
                        <div className="basis-1/3 relative">
                            <img src={burger1} alt="category image" className="absolute w-28 -button-4 left-4"/>
                        </div>
                        <div className="mb-2">
