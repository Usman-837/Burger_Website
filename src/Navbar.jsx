...
const Navbar = () => {
    ...
    return(
        <>
            <header className="bg-primaryColor fixed left-0 top-0 w-full z-50">
                ...
                {
                    menu ? <div className="absolute top-0 left-0 w-full py-14 bg-primaryColor border-b border-secondaryColor flex flex-col text-center gap-5">
